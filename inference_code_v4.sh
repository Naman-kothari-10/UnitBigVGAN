...
for lang_pair in $LANGS; do
    ...
    OUTPUT_DIR="/nlsasfs/home/dibd/dibd-speech/iitm/laish/naman/exps/CodeBigvgan/inference_outputs/v4/500/${LANG_NAME}"
    CHKPT_PATH="/nlsasfs/home/dibd/dibd-speech/iitm/laish/naman/exps/CodeBigvgan/checkpoints/v4/500/g_00400000"
    UNIT_FILEPATH="/nlsasfs/home/dibd/dibd-speech/iitm/laish/naman/data/ivr/units_aqc/kmeans_500/${LANG_NAME}/test/units_uc"
    CONFIG_FILEPATH="/nlsasfs/home/dibd/dibd-speech/iitm/laish/naman/exps/CodeBigvgan/configs_codebigvgan/config_v4_500.json"
