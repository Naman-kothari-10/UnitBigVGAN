...
for lang_pair in $LANGS; do
    ...
    OUTPUT_DIR="/nlsasfs/home/dibd/dibd-speech/iitm/laish/naman/exps/CodeBigvgan/inference_outputs/v2/500/${LANG_NAME}"
    # OUTPUT_DIR="/nlsasfs/home/dibd/dibd-speech/iitm/laish/naman/exps/CodeBigvgan/inference_outputs_cross_lingual_spk_mixing/hin_tel__ben_tam/v2/1k/${LANG_NAME}"
    CHKPT_PATH="/nlsasfs/home/dibd/dibd-speech/iitm/laish/naman/exps/CodeBigvgan/checkpoints/v2/500/g_00400000"
    UNIT_FILEPATH="/nlsasfs/home/dibd/dibd-speech/iitm/laish/naman/data/ivr/units_aqc/kmeans_500/${LANG_NAME}/test/units_uc"
    CONFIG_FILEPATH="/nlsasfs/home/dibd/dibd-speech/iitm/laish/naman/exps/CodeBigvgan/configs_codebigvgan/config_v2_500.json"
